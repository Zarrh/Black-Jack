...
def findHull(img, corner=refCornerHL, debug="no"):
    ...
    if debug != "no" :
        if concat_contour is not None:
            ...
            cv2.drawContours(img, [hull_in_img], 0, (255,0,0), 1)
...
# Save the images in a pickle file #
"""
imgs_dir="data/cards"
...
for suit in card_suits:
    for value in card_values:
        ...
        for f in glob(card_dir + "/*.png"):
            ...
            cards[card_name].append((img, refCornerHL, refCornerLR))
